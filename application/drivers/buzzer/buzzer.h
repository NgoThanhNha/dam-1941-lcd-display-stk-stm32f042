...
/*                         buzzer pin map                          */ 
/*-----------------------------------------------------------------*/
#define BUZZER_IO_PIN					(GPIO_Pin_1)
#define BUZZER_IO_PORT					(GPIOB)
#define BUZZER_IO_CLOCK					(RCC_AHBPeriph_GPIOB)

#define BUZZER_IO_AF                    (GPIO_AF_1)
#define BUZZER_IO_SOURCE                (GPIO_PinSource1)
...
static const Tone_TypeDef tone_3_beep[] = {
	{4000, 3},
	{   0,10},
	{1000, 6},
	{   0,10},
...
static const Tone_TypeDef tone_1_beep[] = {
    {4000, 3},
    {   0,0}
};
